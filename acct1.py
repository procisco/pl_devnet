...
class BussinessCustomer:
    ...
    their finance department. Sometimes observers are called subscribers
    too.
    """

    def __init__(self, acct_id, money_owed):
        """
        Constructor to store the account ID and the current amount
        of money owed.
        """
    ...
    def update(self):
        """
        When the accounting system (the subject or the publisher) needs to notify
...
def main():
    ...
    cust1 = BussinessCustomer("ACCT100", 10)
    cust2 = BussinessCustomer("ACCT200", 0)
    ...
    # Event occurred again, and notice how cust2 is not displayed
    accounting_sys.notify()
